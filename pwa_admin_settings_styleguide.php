...
/**
 * Class pwa_admin_settings_styleguide
 *
 * @package   theme_pwa
 * @copyright 2020 Jo Beaver
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class pwa_admin_settings_styleguide extends admin_setting_heading {
    ...
    public function output_html($data, $query = '') {
        ...
        return $OUTPUT->render_from_template('theme_pwa/admin_setting_styleguide', $context);
    }
}